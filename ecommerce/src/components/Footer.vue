<template>
  <v-footer dark padless>
    <v-card flat tile class="gray white--text py-12 px-5" width="100%">
      <v-row>
        <v-col cols="12" sm="4">
          ...
          <v-card-text class="grey--text pt-0">
            much. Although sometimes we might become angry at one another, very soon we <br>
            will forget the unpleasant things. We're a happy family, how about you?'
          </v-card-text>
